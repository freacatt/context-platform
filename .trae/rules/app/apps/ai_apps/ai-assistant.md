...
The AI Assistant is a chat-style app and does not introduce a new persisted domain entity. It uses the existing `Conversation` and `StoredMessage` types defined in [app/src/types/index.ts](file:///home/pouria/projects/pyramid-solver/app/src/types/index.ts).
...
The main UI page for the AI Assistant is implemented in [app/src/pages/AiChatPage.tsx](file:///home/pouria/projects/pyramid-solver/app/src/pages/AiChatPage.tsx). It provides:
- **Conversation List**:
...
The orchestration logic for AI calls lives in [app/src/services/aiService.ts](file:///home/pouria/projects/pyramid-solver/app/src/services/aiService.ts) and [app/src/services/anthropic.ts](file:///home/pouria/projects/pyramid-solver/app/src/services/anthropic.ts):
