...
- **Template Initialization**: `createProductDefinition` creates a new definition from a selected template ID:
  - Templates are defined in [src/services/productDefinitionTemplates.ts](file:///home/pouria/projects/pyramid-solver/src/services/productDefinitionTemplates.ts).
